      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
        {dealsToDisplay.map((product) => (
          ...
          >
            ...
            {/* Price & Action Button */}
            <div className="pt-3 sm:pt-4 border-t border-[#1E1E2E] space-y-2.5 mt-3">
              <div className="flex items-baseline justify-between gap-2">
                <span className="text-lg sm:text-xl font-black text-amber-400 tracking-tight whitespace-nowrap">
              ...
              <button
                ...
                className="w-full py-2.5 sm:py-3 rounded-2xl bg-gradient-to-r from-amber-500 to-[#FF1E27] hover:opacity-90 text-white font-bold text-xs flex items-center justify-center gap-2 transition-all shadow-[0_5px_15px_rgba(255,184,0,0.3)] active:scale-95 min-h-[42px] whitespace-nowrap"
              >
                <ShoppingBag size={15} />
